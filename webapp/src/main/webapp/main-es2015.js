...
module.exports = __webpack_require__(/*! /Users/toygan/Desktop/Mercedes/final/code-challange/webapp/front-end/src/main.ts */"zUnb");
...
/* harmony import */ var _http_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./http-service */ "m5qE");
...
let HttpService = /** @class */ (() => {
    let HttpService = class HttpService {
        ...
        get(uri) {
            const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}` + uri;
            console.log('get : ' + url);
        ...
        post(uri, o) {
            ...
            return this.http.post(url, o, { headers: this.headers }).pipe();
        }
    };
